If you accidentally created a database or find that you no longer need a database, you may want to delete it. To do this, you can use the `DROP DATABASE` statement: 
