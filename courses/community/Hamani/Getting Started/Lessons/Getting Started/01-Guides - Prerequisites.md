...
Lastly, in this guide we'll be using a [SQLite](https://sqlite.org/) database. This and Ruby are already installed in this lesson envrionment, so you can just jump right in!
