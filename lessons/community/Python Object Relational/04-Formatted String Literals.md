[**PEP 498**](https://www.python.org/dev/peps/pep-0498) introduces a new kind of string literals: _f-strings_, or [formatted string literals](https://docs.python.org/reference/lexical_analysis.html#f-strings).
